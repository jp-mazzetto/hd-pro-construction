...
const App = () => {
  ...
  return (
    <>
      <Helmet>
        <title>
          HD Pro Construction | Pavers, Masonry & Excavation in Boston
        </title>
        <meta
          name="description"
          ...
          <div className="container mx-auto px-6 relative z-10">
            <div className="max-w-4xl">
              ...
              <div className="flex flex-wrap gap-x-4 gap-y-2 text-orange-500 font-black uppercase tracking-widest text-sm mb-10 border-l-4 border-orange-600 pl-6">
                <span>Pavers</span> | <span>Brick</span> | <span>Walkways</span>{" "}
                | <span>Stone Walls</span> | <span>Excavation</span> |{" "}
                <span>Fences</span> | <span>Paint</span> |{" "}
                <span>Landscape</span> | <span>Decks</span>
              </div>

              <div className="flex flex-col sm:flex-row gap-6">
                <Button
                  onClick={handleSmsRequest}
                  className="text-xl py-6 px-12 group"
                >
                  <MessageSquare
                    size={28}
          ...
          <div className="container mx-auto px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
              {services.map((service, idx) => (
                <div
                  key={idx}
                  className="group bg-white p-10 rounded-2xl shadow-xl hover:shadow-2xl transition-all border-l-8 border-transparent hover:border-orange-600 relative overflow-hidden"
                >
                  ...
                  <div
                    className="flex items-center gap-2 text-orange-600 font-black uppercase tracking-widest text-xs group-hover:gap-4 transition-all cursor-pointer"
                    onClick={() => handleSmsRequest(service.title)}
                  >
                ...
                <div className="flex gap-4 items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-500 text-sm">
                      We provide honest on-site evaluations for every project.
                    </p>
                  </div>
                </div>
                <div className="flex gap-4 items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-500 text-sm">
                      Licensed professionals with years of hard-won field
                      experience.
                    </p>
                  </div>
                </div>
          ...
          <div className="container mx-auto px-6 text-center">
            <div className="max-w-4xl mx-auto bg-white p-16 md:p-24 rounded-[60px] shadow-[0_50px_100px_-20px_rgba(0,0,0,0.15)] border border-gray-100">
              ...
              <p className="text-xl text-gray-500 mb-12 max-w-2xl mx-auto font-medium text-center">
                Let's discuss your next project. We are ready to help you
                transform your outdoor space in Boston, Massachusetts.
              </p>
              <div className="flex flex-col md:flex-row justify-center gap-6">
                <Button
                  onClick={handleSmsRequest}
                  className="text-2xl py-8 px-16 shadow-2xl"
                >
          ...
          <div className="container mx-auto px-6">
            <div className="grid md:grid-cols-4 gap-16 mb-24">
              <div className="md:col-span-2">
                ...
                <p className="text-gray-500 max-w-sm font-medium italic mb-8">
                  The leading choice for outdoor transformations in Boston.
                  Built with integrity, precision, and grit.
                </p>
                ...
                <ul className="space-y-6 text-gray-400 font-bold">
                  ...
                  <li className="flex items-start gap-3">
                    ...
                    <span className="text-xs font-black uppercase italic text-white leading-tight">
                      Serving all of Boston, Massachusetts
                    </span>
                  </li>
                </ul>
              </div>
            ...
            <div className="pt-12 border-t border-gray-900 flex flex-col md:row justify-between items-center gap-6">
              <p className="text-gray-600 font-bold uppercase text-[10px] tracking-[0.3em]">
                © 2024 HD PRO CONSTRUCTION INC | Built for Excellence
              </p>
